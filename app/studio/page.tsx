          ...
          <aside className="side-panel card">
            {step === 4 && selectedLayer ? (
              <>
                ...
                <div className="style-row"><button type="button" className={selectedLayer.bold ? "toggle-on" : "ghost"} onClick={() => updateLayer(selectedLayer.id, { bold: !selectedLayer.bold })}>B</button><button type="button" className={selectedLayer.italic ? "toggle-on" : "ghost"} onClick={() => updateLayer(selectedLayer.id, { italic: !selectedLayer.italic })}>I</button><button type="button" className={selectedLayer.align === "left" ? "toggle-on" : "ghost"} onClick={() => updateLayer(selectedLayer.id, { align: "left" })}>L</button><button type="button" className={selectedLayer.align === "center" ? "toggle-on" : "ghost"} onClick={() => updateLayer(selectedLayer.id, { align: "center" })}>C</button><button type="button" className={selectedLayer.align === "right" ? "toggle-on" : "ghost"} onClick={() => updateLayer(selectedLayer.id, { align: "right" })}>R</button></div>
              </>
            ) : (
              <>
